...
all_settings  = ["AccessModifierOffset", "AlignAfterOpenBracket", "AlignArrayOfStructures",
    "AlignConsecutiveAssignments", "AlignConsecutiveBitFields", "AlignConsecutiveDeclarations",
    "AlignConsecutiveMacros", "AlignEscapedNewlines", "AlignOperands", "AlignTrailingComments",
    "AllowAllArgumentsOnNextLine", "AllowAllConstructorInitializersOnNextLine",
    "AllowAllParametersOfDeclarationOnNextLine", "AllowShortBlocksOnASingleLine",
    "AllowShortCaseLabelsOnASingleLine", "AllowShortEnumsOnASingleLine",
    "AllowShortFunctionsOnASingleLine", "AllowShortIfStatementsOnASingleLine",
    "AllowShortLambdasOnASingleLine", "AllowShortLoopsOnASingleLine",
    "AlwaysBreakAfterDefinitionReturnType", "AlwaysBreakAfterReturnType",
    "AlwaysBreakBeforeMultilineStrings", "AlwaysBreakTemplateDeclarations", "AttributeMacros",
    "BasedOnStyle", "BinPackArguments", "BinPackParameters", "BitFieldColonSpacing",
    "BraceWrapping", "BreakAfterJavaFieldAnnotations", "BreakBeforeBinaryOperators",
    "BreakBeforeBraces", "BreakBeforeConceptDeclarations", "BreakBeforeInheritanceComma",
    "BreakBeforeTernaryOperators", "BreakConstructorInitializers",
    "BreakConstructorInitializersBeforeComma", "BreakInheritanceList", "BreakStringLiterals",
    "ColumnLimit", "CommentPragmas", "CompactNamespaces",
    "ConstructorInitializerAllOnOneLineOrOnePerLine", "ConstructorInitializerIndentWidth",
    "ContinuationIndentWidth", "Cpp11BracedListStyle", "DeriveLineEnding", "DerivePointerAlignment",
    "DisableFormat", "EmptyLineAfterAccessModifier", "EmptyLineBeforeAccessModifier",
    "ExperimentalAutoDetectBinPacking", "FixNamespaceComments", "ForEachMacros", "IfMacros",
    "IncludeBlocks", "IncludeCategories", "IncludeIsMainRegex", "IncludeIsMainSourceRegex",
    "IndentAccessModifiers", "IndentCaseBlocks", "IndentCaseLabels", "IndentExternBlock",
    "IndentGotoLabels", "IndentPPDirectives", "IndentRequiresClause", "IndentWidth",
    "IndentWrappedFunctionNames", "InsertBraces", "InsertTrailingCommas", "JavaScriptQuotes",
    "JavaScriptWrapImports", "KeepEmptyLinesAtTheStartOfBlocks", "LambdaBodyIndentation",
    "MacroBlockBegin", "MacroBlockEnd", "MaxEmptyLinesToKeep", "NamespaceIndentation",
    "ObjCBinPackProtocolList", "ObjCBlockIndentWidth", "ObjCBreakBeforeNestedBlockParam",
    "ObjCSpaceAfterProperty", "ObjCSpaceBeforeProtocolList", "PackConstructorInitializers",
    "PenaltyBreakAssignment", "PenaltyBreakBeforeFirstCallParameter", "PenaltyBreakComment",
    "PenaltyBreakFirstLessLess", "PenaltyBreakOpenParenthesis", "PenaltyBreakString",
    "PenaltyBreakTemplateDeclaration", "PenaltyExcessCharacter", "PenaltyIndentedWhitespace",
    "PenaltyReturnTypeOnItsOwnLine", "PointerAlignment", "PPIndentWidth", "QualifierAlignment",
    "ReferenceAlignment", "ReflowComments", "RemoveBracesLLVM", "RequiresClausePosition",
    "SeparateDefinitionBlocks", "ShortNamespaceLines", "SortIncludes", "SortJavaStaticImport",
    "SortUsingDeclarations", "SpaceAfterCStyleCast", "SpaceAfterLogicalNot",
    "SpaceAfterTemplateKeyword", "SpaceAroundPointerQualifiers", "SpaceBeforeAssignmentOperators",
    "SpaceBeforeCaseColon", "SpaceBeforeCpp11BracedList", "SpaceBeforeCtorInitializerColon",
    "SpaceBeforeInheritanceColon", "SpaceBeforeParens", "SpaceBeforeParensOptions",
    "SpaceBeforeRangeBasedForLoopColon", "SpaceBeforeSquareBrackets", "SpaceInEmptyBlock",
    "SpaceInEmptyParentheses", "SpacesBeforeTrailingComments", "SpacesInAngles",
    "SpacesInConditionalStatement", "SpacesInContainerLiterals", "SpacesInCStyleCastParentheses",
    "SpacesInLineCommentPrefix", "SpacesInParentheses", "SpacesInSquareBrackets", "Standard",
    "StatementAttributeLikeMacros", "StatementMacros", "TabWidth", "UseCRLF", "UseTab",
